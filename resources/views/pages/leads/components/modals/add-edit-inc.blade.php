<div class="row">
    <div class="col-lg-12">
        ...
        <div class="modal-meta-data">
            <small><strong>{{ cleanLang(__('lang.created_by')) }}:</strong> {{ $lead->first_name ?? runtimeUnkownUser() }} |
        ...
        <!--email-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.email_address')) }}</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <!--value-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.lead_value')) }} ({{
        ...
        <div class="hidden" id="add_lead_details">
            ...
            <!--lead sources-->
            <div class="form-group row">
                <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.source')) }}</label>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm pickadate" autocomplete="off"
                        name="lead_last_contacted" value="{{ runtimeDatepickerDate($lead->lead_last_contacted ?? '') }}">
                    <!--mysql date format-->
