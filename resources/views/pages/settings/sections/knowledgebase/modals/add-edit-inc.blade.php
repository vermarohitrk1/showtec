...
<div class="form-group row">
    ...
    <div class="col-12">
        <select class="select2-basic form-control form-control-sm" id="kbcategory_visibility"
            ...
            <option value="team" {{ runtimePreselected('team', $category->kbcategory_visibility ?? '') }}>{{ cleanLang(__('lang.team')) }}
            </option>
...
<div class="line"></div>
<div class="form-group row">
    <label class="col-12 text-left control-label col-form-label required">{{ cleanLang(__('lang.move_artiles_to_another_category')) }} ({{ cleanLang(__('lang.optional')) }})</label>
    <div class="col-12">
