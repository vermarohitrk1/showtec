...
<form class="form" id="settingsFormCurrency">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            ...
            <select class="select2-basic form-control form-control-sm select2-preselected" id="settings_system_currency_code" data-preselected="{{ $settings->get_key('settings_system_currency_code') ?? ''}}"
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_system_currency_symbol"
                name="settings_system_currency_symbol" value="{{ $settings->get_key('settings_system_currency_symbol') }}">
        </div>
    </div>
        ...
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_decimal_separator"
                ...
                <option value="fullstop"
                    {{ runtimePreselected('fullstop', $settings->get_key('settings_system_decimal_separator') ?? '') }}>
                    . ({{ cleanLang(__('lang.full_stop')) }})</option>
                <option value="comma"
                    {{ runtimePreselected('comma', $settings->get_key('settings_system_decimal_separator') ?? '') }}>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_thousand_separator"
                ...
                <option value="fullstop"
                    {{ runtimePreselected('fullstop', $settings->get_key('settings_system_thousand_separator') ?? '') }}>
                    . ({{ cleanLang(__('lang.full_stop')) }})</option>
                <option value="comma"
                    {{ runtimePreselected('comma', $settings->get_key('settings_system_thousand_separator') ?? '') }}>
                    , ({{ cleanLang(__('lang.comma')) }})</option>
                <option value="apostrophe"
                    {{ runtimePreselected("apostrophe", $settings->get_key('settings_system_thousand_separator') ?? '') }}>
                    ' ({{ cleanLang(__('lang.apostrophe')) }})</option>
                <option value="none"
                    {{ runtimePreselected('none', $settings->get_key('settings_system_thousand_separator') ?? '') }}>
                    {{ cleanLang(__('lang.none')) }}</option>
                <option value="space"
                    {{ runtimePreselected('space', $settings->get_key('settings_system_thousand_separator') ?? '') }}>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_currency_position"
                ...
                <option value="left"
                    {{ runtimePreselected('left', $settings->get_key('settings_system_currency_position') ?? '') }}>
                    {{ cleanLang(__('lang.left')) }}</option>
                <option value="right"
                    {{ runtimePreselected('right', $settings->get_key('settings_system_currency_position') ?? '') }}>
