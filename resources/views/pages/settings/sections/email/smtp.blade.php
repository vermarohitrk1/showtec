...
<form class="form" id="settingsFormEmailSMTP">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_email_smtp_host"
                name="settings_email_smtp_host" value="{{ $settings->get_key('settings_email_smtp_host') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_email_smtp_port"
                name="settings_email_smtp_port" value="{{ $settings->get_key('settings_email_smtp_port') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_email_smtp_username"
                name="settings_email_smtp_username" value="{{ $settings->get_key('settings_email_smtp_username') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_email_smtp_password"
                name="settings_email_smtp_password" value="{{ $settings->get_key('settings_email_smtp_password') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_email_smtp_encryption"
                ...
                <option value="tls" {{ runtimePreselected('tls', $settings->get_key('settings_email_smtp_encryption') ?? '') }}>
                    TLS</option>
                <option value="starttls"
                    {{ runtimePreselected('starttls', $settings->get_key('settings_email_smtp_encryption') ?? '') }}>
                    STARTTLS</option>
                <option value="ssl" {{ runtimePreselected('ssl', $settings->get_key('settings_email_smtp_encryption') ?? '') }}>
                    SSL</option>
            </select>
        </div>
    </div>
    ...
    @if($settings->get_key('settings_cronjob_has_run') != 'yes')
