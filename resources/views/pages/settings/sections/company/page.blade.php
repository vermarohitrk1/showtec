    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_name"
                name="settings_company_name" value="{{ $settings->get_key('settings_company_name') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_address_line_1"
                name="settings_company_address_line_1" value="{{ $settings->get_key('settings_company_address_line_1') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_city"
                name="settings_company_city" value="{{ $settings->get_key('settings_company_city') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_state"
                name="settings_company_state" value="{{ $settings->get_key('settings_company_state') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_zipcode"
                name="settings_company_zipcode" value="{{ $settings->get_key('settings_company_zipcode') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_country"
                name="settings_company_country" value="{{ $settings->get_key('settings_company_country') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_telephone"
                name="settings_company_telephone" value="{{ $settings->get_key('settings_company_telephone') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_customfield_1"
                name="settings_company_customfield_1" value="{{ $settings->get_key('settings_company_customfield_1') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_customfield_2"
                name="settings_company_customfield_2" value="{{ $settings->get_key('settings_company_customfield_2') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_customfield_3"
                name="settings_company_customfield_3" value="{{ $settings->get_key('settings_company_customfield_3') ?? '' }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_company_customfield_4"
                name="settings_company_customfield_4" value="{{ $settings->get_key('settings_company_customfield_4') ?? '' }}">
        </div>
    </div>
    <div>
