...
<tr id="category_{{ $category->category_id }}">
    ...
    <td class="categories_col_created_by">
        <img src="{{ getUsersAvatar($category->avatar_directory, $category->avatar_filename, $category->category_creatorid) }}" alt="user"
    ...
    <td class="categories_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="{{ cleanLang(__('lang.delete')) }}" class="data-toggle-action-tooltip btn btn-outline-danger btn-circle btn-sm confirm-action-danger"
                ...
                data-ajax-type="DELETE" data-url="{{ url('/') }}/categories/{{ $category->category_id }}">
            ...
            <button type="button" title="{{ cleanLang(__('lang.edit')) }}"
                ...
                data-action-url="{{ url('/categories/'.$category->category_id.'?filter_category_type='.$category->category_type) }}" data-action-method="PUT"
