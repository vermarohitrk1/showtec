...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        ...
        @include('pages.employee.components.misc.crumbs')

        @include('pages.employee.components.misc.actions')
    ...
    <div class="row">
        ...
        <div class="col-xl-3 d-none d-xl-block">
            @include('pages.employee.components.misc.leftpanel')
        </div>
        <!--left panel-->
        <!-- Column -->
        <div class="col-xl-9 col-lg-12">
            <div class="card h-100">
                ...
                <!--top nav-->
                @include('pages.employee.components.misc.topnav')
