<head>
    ...
    <title>{{ config('system.settings_company_name') }} {{ $page['meta_title'] ?? '' }}</title>
    ...
    <!--[if lt IE 9]>
    <script src="{{ asset('/vendor/js/html5shiv/html5shiv.js')}}"></script>
    <script src="{{ asset('/vendor/js/respond/respond.min.js')}}"></script>
    <![endif]-->
    ...
    <!-- Font Awesome -->
    <!-- <link rel="stylesheet" href="{{ asset('/hrms/skin/hrsale_assets/theme_assets/bower_components/font-awesome/css/font-awesome.min.css') }}"> -->

    <!--USERS CUSTON CSS FILE-->
    <link href="{{ asset('/css/custom.css?v='. config('system.versioning')) }}" rel="stylesheet">
    ...
    <script type="text/javascript">
        ...
        NXPURCHASEORDER = (typeof NXPURCHASEORDER == 'undefined') ? {} : NXPURCHASEORDER;
        ...
        NXPURCHASEORDER.DATA = {};
        NXPURCHASEORDER.DOM = {};
        NXPURCHASEORDER.CALC = {};

        //variables
        NX.site_url = "{{ url('/') }}";
        NX.base_url = "{{ env('APP_URL') }}";
    ...
    <!--boot js-->
    <script src="{{ asset('/js/core/head.js?v='. config('system.versioning')) }}"></script>
