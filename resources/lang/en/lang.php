...
return [
    ...
    'add_employee_manager' => "Add Employee Manager",
    ...
    'all_setting_permissions_when_adding_project' => "Allow user to set employee and staff permissions when adding a new project",
    'all_tasks' => "All Tasks",
    ...
    'august_short' => "Aug",
    'august' => "August",
    'available_to_all_employees' => "Available to all employees",
    ...
    'employee_already_exists' => "This employee already exists",
    'employee_email_required_for_dashboard_access' => "Employee name & email address are required for a contact with dashboard access",
    'employee_emails' => "Employee Emails",
    'employee_files' => "Employee Files",
    'employee_has_not_paid_for_subsccrition' => "Employee has not yet paid for this subscription",
    'employee_has_not_yet_accepted_the_contract' => "Employee has not yet accepted the contract",
    'employee_id' => "Employee ID",
    'employee_is_required' => "A employee is required",
    'employee_manager_information' => "A employee manager will have full access to all the employees projects, billing etc",
    ...
    'employee_project_permissions' => "Employee's Project Permissions",
    'employee_project' => "Employee & Project",
    'employee_rejected_the_contract' => "Employee rejected the contract",
    'employee_signature' => "Employee Signature",
    'employee_users' => "Employee Users",
    'employee_visibility_invalid' => "Employee visibility option is invalid",
    ...
    'delete_employee_manager' => "Delete Employee Manager",
    ...
    'expense_has_already_been_invoiced' => "This expense has been invoiced. Employee and project can longer be changed",
    ...
    'not_visible_to_the_employee' => "not visible to the employee",
    'not_visisble_to_employee' => "Not visible to the employee",
    ...
    'only_available_to_specified_customers' => "Only available to specified employees",
    ...
    'project_cost_estimate_info' => "Your projected expenses on this project. This information is not visible to the employee. You can also leave it blank.",
    ...
    'project_notes_not_visible_to_employee' => "Project notes are not visible to the employee",
    ...
    'send_email_to_employee' => "Send an email to the employee",
    ...
    'star_item' => "Star Item",
    'starred_employees' => "Starred Employee",
    ...
    'subscription_log_cancelled_employee' => "Subscription was cancelled by the employee",
    ...
    'disable_all_employee_emails' => "Disable all employee emails",
    'disable_employee_emails_notes' => "The system will not send any emails to employee users",
    'allow_employees_to_login' => "Allow employees to login",
    'employees_disabled_login_error' => "Access denied. Please contact customer support for assistance",
    ...
    'show_if_employee_has_opened' => "Show if it has been viewed by the employee",
    'set_to_opened' => "Change - Opened",
    'set_to_not_opened' => "Change - Not Opened",
    'employee_has_opened' => "employee has opened",
    'employee_has_not_opened' => "employee has not opened",
    ...
    'po_date' => "PO Date",
    'ref_no' => "Ref No",
    'po_not_found' => "Purchase Order could not be found",
    'edit_purchase_order' => "Edit Purchase Order",
    'email_to_vendor' => "Email To Vendor",
    'clone_purchase_order' => "Clone Purchase Order",
    'release_purchase_order' => "Release Purchase Order",
    'the_purchase_order_will_be_sent_to_vendor' => "The purchase order will be emailed to the vendor",
    'delete_purchase_order' => "Delete Purchase Order",
    'released' => "Released",
    'received' => "Received",
    'ship_to' => "Ship To",
    'purchase_order_products' => "Purchase Order Products",
    'purchase_order_total' => "Order Total",
    'manufacturer' => "Manufacturer",
    'item_number' => "Item No",
    'freight' => "Freight",
    'remove_freight' => "Remove Freight",
    ...
    'warehouse_manager_info' => "A warehouse manager will have admin level permissions to manage all aspects of this warehouse",
    'racks'  => "Racks",
    'rack'  => "Rack",
    'item_no_examples' => "Product number",
    'save_and_authorize' => "Save & Authorize",
    'the_purchase_order_will_be_authorize' => "The purchase order will be authorized to send to vendor",
    'purchase_order_already_authorized' => "This purchase order has already been authorized",
    'event_created_purchase_order' => "Created a new purchase order",
    'purchase_order_already_released' => "This purchase order has already been released",
    'vendor_not_found' => "Vendor could not be found",
    'event_released_purchase_order' => "Released a new purchase order to vendor",
    'add_rack'  => "Add Rack",
    'delete_rack'  => "Delete Rack",
    'edit_rack'  => "Edit Rack",
    'rack_title' => "Rack Title",
    'product_categories' => "Product Categories",
    'rack_product_categories_info' => "Allows products/items from the selected categories to be store on a rack. To allow all products/items leave it empty",
    'layers' => "Layers",
    'layer_capacity' => "Layer Capacity",
    'layer_capacity_info' => "Load Capacity of each layer in KGs",
    'layers_info' => "No. of Layers in a rack",
    'height' => "Height",
    'height_info' => "Height (in cm)",
    'width' => "Width",
    'width_info' => "Width (in cm)",
    'depth' => "Depth",
    'depth_info' => "Depth (in cm)",
    'product_capacity' => "Product Capacity",
    'product_capacity_info' => "No. of Products that can store in a rack",
    'dimensions' => "Dimensions",
    'info' => 'Info',
    'payment_info' => 'Payment Info',
    'add_vendor_row' => 'Add More Info',
    'purchase_orders' => 'Purchase Orders',
    'add_vendor_files' => 'Add Vendor File',
    'delete_vendor_file' => 'Delete Vendor File',
    ...
    'delete_asset' => "Delete Fixed Asset",
    'asset_name' => 'Name',
    ...
    'add_return'  => "Add Return / Exchange",
    'edit_return' => "Edit Return / Exchange",
    'delete_return' => "Delete Return / Exchange",
    'return_order_id' => 'Order ID',
    'return_type' => 'Type',
    'return_status' => 'Status',
    'return_remarks' => 'Remarks',
    'inbound_outbound' => 'Inbound / Outbound',
    'add_inbound_outbound'  => "Add Inbound / Outbound",
    'edit_inbound_outbound' => "Edit Inbound / Outbound",
    'delete_inbound_outbound' => "Delete Inbound / Outbound",
    'inbound_outbound_id' => 'ID',
    'bound_type' => 'Type',
    'bound_status' => 'Status',
    'bound_remarks' => 'Remarks',
    'bound_ref' => 'Ref ID',
    'downloadInvoice' => 'Download Invoice',
    'quotation' => 'Quotation',
    'deliveryNote' => 'Delivery Note',
    'taxInv' => 'Tax Invoice',
    'customerInv' => 'Customer Invoice',
    'purchase_order' => 'Purchase Order',
    'pi_SGD' => 'Proforma Invoice (SGD)',
    'pi_USD' => 'Proforma Invoice (USD)',
    'contactperson' => 'Contact Person',
    'payment_terms' => 'Payment Terms',
    'leadtime' => 'Est. Delivery Lead Time',
    ...
    'manage_mcs'=>'Manage MCs',
    'location' => 'Location',
    'designation' => 'Designation',
    'outstanding_claims' => 'Outstanding Claims',
    'faulty_equipments' => 'Faulty Equipments',
    'inventory' => 'Inventory',
    'add_inventory' => 'Add New Item',
    'item_name' => 'Item Name',
    'quantity_short' => 'Qty',
    ...
    'remark' => 'Remark',
    'freight_dimensions' => 'Freight Dimensions',
    'freight' => 'Freight',
    'next_booked_date' => 'Next Booked Date',
    'length' => 'Length',
    'weight' => 'Weight',
    'highlight' => 'Highlight',
    'schedule' => 'Schedule',
    'condemn' => 'Condemn',
    'total_must_smaller_then_quantity' => 'Total must be less then items quantity.'
