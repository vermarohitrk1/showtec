...
return [
    ...
    /**
     * Purchase orders - Default results table sorting
     *
     *   [sort_by] (available options)
     *    - po_invoiceid
     *    - po_date
    ...
    'ordering_purchase_orders' => [
        'sort_by' => 'po_invoiceid',
        'sort_order' => 'DESC',
    ],

    /**
     * Various purchase order statuses, with their corresponding bootstrap colors (colors are used for labels etc)
     * The following colors are available: (default|info|warning|success|danger|primary|green|lime|brown)
     * [IMPORTANT WARNING]
     * Only change the color values
     */
