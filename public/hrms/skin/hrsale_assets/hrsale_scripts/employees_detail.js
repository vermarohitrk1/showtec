$(document).ready(function(){			
	...
	$('.edit-modal-data').on('show.bs.modal', function (event) {
		...
		if(field_tpe == 'contact'){
			...
			var field_add = '&data=employee_leave&type=employee_leave&';
		}
		var modal = $(this);
		$.ajax({
...
//$('#hrload-img').hide();
	...
	$(".leave-tab").click(function(){
		var profile_id = $(this).data('profile');
		var profile_block = $(this).data('profile-block');
		$('.leave-tab-list').removeClass('active');
		$('.leave-current-tab').hide();
		$('#luser_profile_'+profile_id).addClass('active');
		$('#'+profile_block).show();
	});
