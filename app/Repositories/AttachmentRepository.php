...
class AttachmentRepository {
    ...
    public function process($data = []) {
        ...
        $new_dir_path = base_path() . "/storage/app/public/files/" . $data["attachment_directory"];
    ...
    public function processAppLogo($data = []) {
        ...
        $new_file = base_path() . "/storage/app/public/logos/app/" . $data["filename"];

        if ($data["logo_size"] == 'large') {
            $current_file = base_path() . "/storage/app/public/logos/app/" . config('system.settings_system_logo_large_name');
        } else {
            $current_file = base_path() . "/storage/app/public/logos/app/" . config('system.settings_system_logo_small_name');
        }
