...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/employees/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/employees/components/table/table';
            ...
            default:
                ...
                $template = 'pages/employees/tabswrapper';
            ...
            if ($employees->currentPage() < $employees->lastPage()) {
                $url = loadMoreButtonUrl($employees->currentPage() + 1, request('source'));
            ...
            //standard view
            $page['url'] = loadMoreButtonUrl($employees->currentPage() + 1, request('source'));
            $page['loading_target'] = 'clients-td-container';
            $page['visibility_show_load_more'] = ($employees->currentPage() < $employees->lastPage()) ? true : false;
            return view('pages/employees/wrapper', compact('employees', 'page'))->render();
        }
