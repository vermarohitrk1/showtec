...
class Fileupload extends Controller {
    ...
    public function save(Request $request) {
        ...
        if ($file = $request->file('file')) {
            ...
            //filepath
            $file_path = base_path() . "/storage/public/temp/$directory/$filename";

            //thumb path
            $thumb_name = generateThumbnailName($filename);
            $thumb_path = base_path() . "/storage/public/temp/$directory/$thumb_name";

            //create directory
            Storage::makeDirectory("public/temp/$directory");

            //save file to directory
            Storage::putFileAs("public/temp/$directory", $file, $filename);
    ...
    public function saveLogo(Request $request) {
        ...
        if ($file = $request->file('file')) {
            ...
            //new filepath
            $file_path = base_path() . "/storage/public/temp/$directory/$filename";
            $file_path = base_path() . "/storage/app/public/temp/$directory/$filename";
            ...
            //if the file type is an image, create a thumb by default
            $imagedata = @getimagesize(base_path() . "/storage/app/public/temp/$directory/$filename");
    ...
    public function saveTinyMCEImage(Request $request) {
        ...
        if ($file = $request->file('file')) {
            ...
            //new filepath
            $file_path = base_path() . "/storage/files/$directory/$filename";
