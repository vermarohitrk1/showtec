...
class Categories extends Controller {
    ...
    public function create(CategoryRepository $categoryrepo) {
        ...
        //client categories
        request()->merge(['filter_category_type'=> request('category_type'),'filter_category_only_parent' => 'yes']);
        $categories = $this->categoryrepo->search();
    ...
    private function pageSettings($section = '', $data = []) {
        ...
        $page = [
            ...
            'form_label_category_color' => __('lang.category_color'),
            'form_label_parent_category' => __('lang.parent_category'),
        ];
